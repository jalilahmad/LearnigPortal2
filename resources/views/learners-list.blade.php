...
<form name="userForm" action="{{ route('learners.store') }}" method="POST">
...
<a href="{{ route('learners.index') }}" class="btn btn-danger">Cancel</a>
</div>
</div>
</form>
</div>
...
<tr><td></td><td style="text-align: right "><a href="{{ route('learners.index') }}" class="btn btn-danger">OK</a> </td></tr>
</table>
</div>
</div>
</div>
...
$.get('learners-list/'+user_id+'/edit', function (data) {
